...
<body style="padding:0px !important; margin:0px !important;-webkit-text-size-adjust:none;" bgcolor="#efefef" >
   ...
   Hi ${userName}, How are you?
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" style="text-decoration:none; margin-right:10px;">
                                <img src="https://s3.amazonaws.com/bookingnet/templates/butt1.jpg">
                            </a>
                            <a href="${reservationWrapper.url}printEmail?emailType=Reservation&reservationId=${reservationWrapper.reservation.altid}" style="text-decoration:none;">
                                <img src="https://s3.amazonaws.com/bookingnet/templates/butt2.jpg">
                            </a>
                        </td>
                        <td style="width:46px;"></td>   
                    </tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important; width:100%;">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <span><img src="https://s3.amazonaws.com/bookingnet/templates/checkboxArrow.png?"></span>
                    ...
                    <tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                            <tr>
                                ...
                                <td align="right">
                                    <a href="#" style="color:#0094F9; font-family:arial; font-size:14px; font-weight:bold; text-decoration:underline; padding-left:5px;">My bookingnet.com.</a>
                                </td>
                            </tr>
                        </table>
                        </td>
                    ...
                    <tr>
                        <td style="width:40px;"></td>
                        <td class="content" style="font-family:arial; font-size:18px; font-style:italic; font-weight:bold; color:#052A4D;">bookingnet.com Customer Service Team</td>
                        <td style="width:46px;"></td>
                    </tr>
                    <tr>
                        <td valign="middle" height="25" colspan="3" class="spacer"></td>
                    ...
                    <tr>
                        <td style="width:40px;"></td>
                        <td class="content">
                        <div style="font-family:arial; font-size:14px; color:#052A4D; width:400px;">Copyright &copy; 2014 <a href="#" style="color:#0094F9; font-family:arial; font-weight:bold; text-decoration:underline;">bookingnet.com</a>. All rights reserved. This email was sent by bookingnet.com</div></td>
                        <td style="width:46px;"></td>
                    </tr>
                    <tr>
