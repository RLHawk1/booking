package com.bookingnet.marshaller.junit;
...
//        Customer customer = (Customer) unmarshaller.unmarshal(new File("src/blog/json/ns/input.xml"));
		...
		imageList.add("http://www.bookingnet.com/a");
		imageList.add("http://www.bookingnet.com/b");
...
//        config.
        ...
        xmlToJsonNamespaces.put("http://www.bookingnet.org/package", "");
        xmlToJsonNamespaces.put("http://www.bookingnet.org/property", "prop");
