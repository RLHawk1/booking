package com.bookingnet.rest.junit;
...
//		sb.append("<?xml version='1.0' encoding='UTF-8' standalone='yes'?>");
		...
		sb.append("</attributes>");
		sb.append("<images>");
		sb.append("<image>https://s3.amazonaws.com/bookingnet/templates/butt2.jpg</image>");
		sb.append("</images>");
		sb.append("</product>");
		...
		// keytool -import -trustcacerts -file /home/cshah/certificates/\*.bookingnet.com -alias bookingnet.com -keystore /usr/lib/jvm/jdk1.7.0_51/jre/lib/security/cacerts 
//		PostMethod post = new PostMethod("https://www.bookingnet.com/xml/rest/product?pos=c709db2e4b15b7fc");
...
//		PostMethod post = new PostMethod("https://www.razor-cloud.com/xml/rest/product?pos=c709db2e4b15b7fc");
		...
		// keytool -import -trustcacerts -file /home/cshah/certificates/\*.bookingnet.com -alias bookingnet.com -keystore /usr/lib/jvm/jdk1.7.0_51/jre/lib/security/cacerts 
//		PostMethod post = new PostMethod("https://www.bookingnet.com/xml/rest/product?pos=c709db2e4b15b7fc");
		PostMethod post = new PostMethod("https://bookingnet.com/xml/services/rest/product?pos=c709db2e4b15b7fc");
		String encoding = DatatypeConverter.printBase64Binary("rose@rentalscapetown.com:rose".getBytes());
		post.addRequestHeader("Authorization", "Basic " + encoding);
		post.addRequestHeader("Accept" , "application/xml");
	...
	public void testGetProduct() {
		...
		String url = "https://www.bookingnet.com/xml/rest/product/${productId}/attribute?pos=c709db2e4b15b7fc&test=true&xsl=http://razor-cloud.com/xsl/pretty.xsl";
