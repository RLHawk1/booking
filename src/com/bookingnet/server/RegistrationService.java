...
public class RegistrationService extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String recipients = "ray@bookingnet.com, brian@bookingnet.com, alex@bookingnet.com";
		...
		if(mail.getStatus() == 0)
		{
			...
			conf.append("Thank you for your registration request with bookingnet."); 
			...
			conf.append("\nPlease contact Ray Karimi, at bookingnet, Inc. with any questions.");
			conf.append("\nE-mail: ray@bookingnet.com");
			conf.append("\nTel. 949-379-8362\n\n\n\n\n");
			conf.append("\nWith bookingnet you can now have your inventory displayed on and distributed in over 50 ");
			...
			conf.append("displayed on and bookingnet will automatically upload and update your property information, ");
			conf.append("availability calendars and rates. www.bookingnet.com");
