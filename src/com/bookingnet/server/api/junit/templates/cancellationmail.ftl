        ...
        <table border="0" cellpadding="0" cellspacing="0" id="mainemailwrap" style="margin:0px !important; padding:0px !important; background-color:#ffffff; width:100%; max-width:652px">
            <tr>
                    ...
                    <tr>
                        ...
                        <td class="promo_image">
                            <div style="float:left;">
                                <img src="https://s3.amazonaws.com/bookingnet/templates/logo.png">
                            </div>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;" id="mainemailwrap" >
                    ...
                    <tr>
                        <td style="width:40px;"></td>
                        <td class="content" style="font-family:Open Sans; color:#052A4D;">Dear ${party.name},</td>
                        <td style="width:46px;"></td>
                    </tr>
                    <tr>
                        <td style="width:40px;"></td>
                        <td class="content" style="font-family:Open Sans; color:#052A4D;">Your reservation at InterContinental Los Angeles Century City at Beverly Hills is now canceled.</td>
                        <td style="width:46px;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  valign="top">
                            <div style="float:left; margin-right:23px;">
                                <img src="https://s3.amazonaws.com/bookingnet/templates/room.jpg"/>
                            </div>
                            <div>
                                <a href="#" style="font-family:Open Sans; text-decoration:underline; color:#0094F9; font-size:22px; font-weight:bold; line-height:26px;">Amelie, Paris France</a>
                            </div>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    <td valign="middle" height="10" colspan="3" class="spacer"></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p style="margin:0; padding:0; color:#052A4D; font-family:Open Sans; font-size:14px;">251 Avenu of the test test testtest</p>
                                        <p style="padding:0; margin:0; font-family:Open Sans; font-size:14px;">Los Angeles (California), CA 90067,</p>
                                        <p style="padding:0; margin:0; font-family:Open Sans; font-size:14px;">United States of America</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle" height="10" colspan="3" class="spacer"></td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" style="color:#0094F9; font-family:Open Sans; font-size:14px; text-decoration:underline;">+3800113322</a></td>
                                </tr>
                                <tr>
                                    <td valign="middle" height="10" colspan="3" class="spacer"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="#" style="color:#0094F9; font-family:Open Sans; font-size:14px; text-decoration:underline;">test@test.com</a></td>
                                </tr>
                            </table>    
                        </td>
                        <td style="width:46px;"></td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td >
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">819635252</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    <td>
                                        <div style="color:#052A4D; font-family:Open Sans; font-weight:bold; font-size:14px; width:220px;">PIN Code:</div>
                                    </td>
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">2920</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">Thursday, November 13, 2014 (3:00 PM)</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">Friday, November 14, 2014 (12:00 PM)</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">Mr Aktay Aydin (<a href="#" style="font-family:Open Sans; text-decoration:underline; color:#0094F9;">${party.emailaddress}</a>)</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">Tuesday, May 6, 2014, 13:45:20 [CET]</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important;">
                                <tr>
                                    ...
                                    <td>
                                        <span style="color:#052A4D; font-family:Open Sans; font-size:14px;">Tuesday, May 6, 2014, 13:48:00 [CET]</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" style="margin:0px !important; padding:0px !important; width:100%;">
                            <tr>
                                ...
                                <td align="right">
                                    <span style="color:#052A4D; font-family:Open Sans; font-size:16px;">US$<span style="padding-left:5px;">0</span></span>
                                </td>
                            </tr>
                        </table>
                        </td>
                    ...
                    <tr>
                        <td style="width:40px;"></td>
                        <td class="content" style="font-family:Open Sans; font-size:12px; color:#052A4D;">Copyright &copy; 2014 <a href="#" style="color:#0094F9; font-family:Open Sans; font-weight:bold; text-decoration:underline;">bookingnet.com</a>. All rights reserved. This email was sent by bookingnet.com</td>
                        <td style="width:46px;"></td>
                    </tr>
                    <tr>
