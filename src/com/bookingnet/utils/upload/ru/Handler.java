package com.bookingnet.utils.upload.ru;
...
import com.bookingnet.server.Uploadable;
import com.bookingnet.utils.upload.ru.request.*;
...
//			property.setIsArchived(false);
		...
		try{
			...
			for (Integer id : importedProducts) {
				...
				if (availabilitiesArray != null && !availabilitiesArray.isEmpty()) {
					com.bookingnet.utils.upload.ru.Calendar calendar = new com.bookingnet.utils.upload.ru.Calendar();
	 ...
	 */
	private void putAvailability(com.bookingnet.utils.upload.ru.Calendar calendar){
	...
	/**
	 * Get Rentals United location code from bookingnet location.
	 * 
	 * @param sqlSession
	 * @param locID - bookingnet location id
