...
/**
 * The Class Slider wraps the JQuery UI Slider and allows for single slider or multiple slider with ranges.
 * @see <pre>http://www.zackgrossbart.com/hackito/gwt-slider/#slider_note1</pre>
 * @see SliderOption for full list of slider options.
 */
public class Slider extends Widget {
	...
	/**
	 * Instantiates a new slider with the specified ID, which is required because the wrapped 
	 * JavaScript slider needs a specific ID to connect to.
	 * 
	 * @param id the id of the element
	 * @param min the default minimum of the slider
	 * @param max the default maximum of the slider
	 * @param defaultValue the default point of a single anchor
	 */
	 ...
	 * @param min the default minimum of the slider
	 * @param max the default maximum of the slider
	 * @param defaultValues the default points of each anchor
	 */
	 ...
	 * 
	 * @param id the id of the element to create
	 * @param options the JSONObject of any possible option, can be null for defaults
	 */
	...
	/**
	 * Convenience method for only one anchor.
	 * 
	...
	public int getValueAtIndex(int index) {
		try {return getValueJS(getElement().getId(), index);} 
		catch(Exception x) {return 0;}
	}

	/**
	 * Sets a slider option numeric value.
	 * 
	 * @param option the slider option.
	...
	/**
	 * Gets a slider option numeric value.
	 * 
	 * @param option the slider option.
	...
	/**
	 * Sets a slider option boolean value.
	 * 
	 * @param option the slider option.
	...
	/**
	 * Gets a slider option boolean value.
	 * 
	 * @param option the slider option.
	...
	/**
	 * Sets a slider option string value.
	 * 
	 * @param option the slider option.
	 ...
	 * 
	 * @param listener the slider listener to add.
	 */
	 ...
	 * 
	 * @param listener the slider listener to remove.
	 */
	 ...
	 * 
	 * @param event when starting.
	 * @param slider values when starting.
	 */
	private void fireOnStartEvent(Event event, JsArrayInteger values) {
		int[] vals = jsArrayIntegerToIntArray(values);
		SliderEvent e = new SliderEvent(event, this, vals);
	 ...
	 * 
	 * @param event when sliding.
	 * @param slider values when sliding.
	 */
	...
	/* 
	 * Fires event on value change.
	 * 
	 * @param event when changed.
	 * @param slider values when changed.
	...
	/* 
	 * Fires event on stop event.
	 * 
	 * @param event when stopping.
	 * @param slider values when stopping.
	 */
	...
	/* 
	 * Gets integer array from the specified JavaScript array.
	 * 
	 * @param values the specified JavaScript array.
	...
	/* JSNI methods to wrap JavaScript. */
	...
	private native void createSliderJS(Slider x, String id, JavaScriptObject options) /*-{
        options.start = function(event, ui) {
            x.@net.cbtltd.client.field.slider.Slider::fireOnStartEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
        options.slide = function(event, ui) {
            return x.@net.cbtltd.client.field.slider.Slider::fireOnSlideEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
        options.change = function(event, ui) {
            var has = event.originalEvent ? true : false;
            x.@net.cbtltd.client.field.slider.Slider::fireOnChangeEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;Z)(event, ui.values, has);                
        };
        options.stop = function(event, ui) {
            x.@net.cbtltd.client.field.slider.Slider::fireOnStopEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
