...
/**
 * The Class ColumnChartField extends VisualizationField for column charts.
 ...
 * @see <pre>http://code.google.com/apis/visualization/documentation/gallery/columnchart.html</pre>
 */
public class ColumnChartField
extends VisualizationField {
	private ColumnChart field = null;

	public ColumnChartField(
			HasComponents form,
			short[] permission,
	 ...
	 */
	private ColumnChart.Options getOptions() {
	...
	private final Runnable onLoadCallback = new Runnable() {
		...
		public void run() {
			if (field == null) {
				field = new ColumnChart(getDataTable(), getOptions());
