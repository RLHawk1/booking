...
public class CarrierInfo {
    ...
    protected List<DepartureDay> departureDay;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the departureDay property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepartureDay().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DepartureDay> getDepartureDay() {
        if (departureDay == null) {
            departureDay = new ArrayList<DepartureDay>();
        }
