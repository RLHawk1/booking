...
@XmlSeeAlso({
    net.cbtltd.soap.ota.server.CustomerType.Email.class,
    net.cbtltd.soap.ota.server.CompanyInfoType.Email.class,
    net.cbtltd.soap.ota.server.EmailsType.Email.class
})
