...
@XmlSeeAlso({
    net.cbtltd.soap.ota.server.ProfileType.Comments.Comment.class,
    net.cbtltd.soap.ota.server.SpecialRequestType.SpecialRequest.class,
    net.cbtltd.soap.ota.server.CommentType.Comment.class
})
