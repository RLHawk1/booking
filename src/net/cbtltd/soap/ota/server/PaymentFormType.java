...
@XmlSeeAlso({
    net.cbtltd.soap.ota.server.CustomerType.PaymentForm.class,
    net.cbtltd.soap.ota.server.CompanyInfoType.PaymentForm.class,
    net.cbtltd.soap.ota.server.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class
})
